    ...
    <div className="min-h-screen text-[#364954] font-sans relative">
      ...
      <section id="teachers" className="py-20 bg-[#f8fafc]">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex items-center justify-center overflow-x-auto pb-8 gap-6 snap-x snap-mandatory scrollbar-hide -mx-4 px-4">
            
            
                <div className="w-50 snap-center rounded-xl p-6 flex flex-col items-center justify-center text-center gap-4">
